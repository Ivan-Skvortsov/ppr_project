# Generated by Django 3.2.7 on 2022-08-03 16:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='bug',
            options={'verbose_name': 'Замечание/предложение', 'verbose_name_plural': 'Замечания/предложения'},
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bug', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bugtracker.bug', verbose_name='Предложение/замечание')),
            ],
            options={
